import { SVG_ICONS } from '@ngld/icon';

const REMOVE_ICON_INFO = {
    name: 'remove_node',
    svgSource: `<svg>
  <defs>
...
export { REMOVE_ICON_INFO, REMOVE_ICON_PROVIDER };
//# sourceMappingURL=ngld-icon-remove.icon.js.map
