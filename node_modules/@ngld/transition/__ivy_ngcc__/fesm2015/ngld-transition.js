...
TransitionService.ɵfac = function TransitionService_Factory(t) { return new (t || TransitionService)(ɵngcc0.ɵɵinject(Array, 8)); };
TransitionService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: TransitionService, factory: TransitionService.ɵfac });
TransitionService.ctorParameters = () => [
    { type: Array, decorators: [{ type: Optional }] }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(TransitionService, [{
        type: Injectable
...
export { easing_function as Easing, InvalidTriggerRegisterError, TransitionService, animate, render, transition, trigger, Trigger as ɵa };
