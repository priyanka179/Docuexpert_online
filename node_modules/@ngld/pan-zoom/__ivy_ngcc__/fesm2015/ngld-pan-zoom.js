...
PanZoomDirective.ɵfac = function PanZoomDirective_Factory(t) { return new (t || PanZoomDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(DOCUMENT)); };
PanZoomDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: PanZoomDirective, selectors: [["", "ngldPanZoom", ""]], hostBindings: function PanZoomDirective_HostBindings(rf, ctx) { if (rf & 1) {
        ɵngcc0.ɵɵlistener("wheel", function PanZoomDirective_wheel_HostBindingHandler($event) { return ctx.onZoom($event); });
    } }, inputs: { viewBox: "viewBox", scaleFactor: "scaleFactor" }, outputs: { viewBoxChanged: "viewBoxChanged" } });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PanZoomDirective, [{
        type: Directive,
        args: [{
...
PanZoomExcludeDirective.ɵfac = function PanZoomExcludeDirective_Factory(t) { return new (t || PanZoomExcludeDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(PanZoomDirective)); };
PanZoomExcludeDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: PanZoomExcludeDirective, selectors: [["", "ngldPanZoomExclude", ""]] });
PanZoomExcludeDirective.ctorParameters = () => [
    { type: ElementRef },
    { type: PanZoomDirective }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PanZoomExcludeDirective, [{
        type: Directive,
        args: [{
                selector: '[ngldPanZoomExclude]'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: PanZoomDirective }]; }, null); })();

class PanZoomDirectiveModule {
}
PanZoomDirectiveModule.ɵfac = function PanZoomDirectiveModule_Factory(t) { return new (t || PanZoomDirectiveModule)(); };
PanZoomDirectiveModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: PanZoomDirectiveModule });
PanZoomDirectiveModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(PanZoomDirectiveModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(PanZoomDirectiveModule, { declarations: [PanZoomDirective, PanZoomExcludeDirective], exports: [PanZoomDirective, PanZoomExcludeDirective] }); })();
