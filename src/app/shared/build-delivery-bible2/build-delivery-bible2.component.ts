...
import { BdbServiceService } from '../build-delivery-bible/services/bdb-service.service';
...
//////
@Component({
  selector: 'app-build-delivery-bible2',
  templateUrl: './build-delivery-bible2.component.html',
  styleUrls: ['./build-delivery-bible2.component.scss'],
  providers: [BdbServiceService]
})
export class BuildDeliveryBible2Component implements OnInit, OnChanges, OnDestroy, AfterViewInit {
